...
* Jira Tickets
** Todo
*** TODO Make the 'Stop' button on the 'Stopwatch' component page stop the counting up sequence
<2023-05-11 Thu 12:55>: I basically just need to use similar code to the 'Timer' component page's 'Stop' button behavior.
*** TODO Make the 'Reset' button on the 'Stopwatch' component page reset the entire sequence
<2023-05-11 Thu 12:56>: I would need to model the behavior off of the existing 'Reset' button on the 'Timer' component page.
*** TODO Make the 'Start' button start a sequence of 4 consecutive beat sounds in a row using a '4/4' time signature
...
** In Progress
*** IN-PROGRESS Make the 'Start' button on the 'Stopwatch' component page start the counting up sequence
