...
*** DONE Force default '/' root page to point to the 'About' component page
...
<2023-05-15 Mon 16:04>: I think the 'Alias' idea for this portion of the 'Vue Router' docs is pertinent for this scenario:
- https://router.vuejs.org/guide/essentials/redirect-and-alias.html

The only difficulty I have is whether I need to stick this within the 'router-link' section within the 'App.vue' file itself, or if this is just something to place inside of the 'main.js' file instead.

<2023-05-15 Mon 16:14>: I re-read that StackOverflow post (https://stackoverflow.com/questions/35664550/vue-js-redirection-to-another-page), and utilized the following answer:
#+begin_src text
...
With this in mind, I called 'router.push' directly via the following change in 'main.js':
#+begin_src js
// Force the application to start on the 'about' page:
router.push({path: '/about'});
#+end_src

This change successfully forces the '/' route upon loading to re-direct to the '/about' route for the 'About' component page :).
*** DONE Test the resulting app in different screen sizes
<2023-05-15 Mon 18:43>: I tested this app on mobile, and it is actually pretty perfect on that screen size, so that's pretty awesome in that regards.
